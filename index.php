...
$botToken = "7056543480:AAEAARVzl4jzMIjijmNb3pcRANol5Qi25Fo";
$website = "https://api.telegram.org/bot" . $botToken;

// Fetch and decode the incoming update from Telegram
$update = file_get_contents('php://input');
$update = json_decode($update, TRUE);

// Print the update for debugging (optional)
$e = print_r($update, true);

// Safely access the data with fallback to null if not available
$chatTitle       = $update['message']['chat']['title'] ?? null; 
...
$new_chat_member = $update['message']['new_chat_member']['username'] ?? null;
$message         = $update['message']['text'] ?? null;
$message_id      = $update['message']['message_id'] ?? null;
$chatId          = $update['message']['chat']['id'] ?? null;
$username2       = $update['message']['from']['username'] ?? null;
$firstname       = $update['message']['from']['first_name'] ?? null;
$cdata2          = $update['callback_query']['data'] ?? null;
$cchatid2        = $update['callback_query']['message']['chat']['id'] ?? null;
$cmessage_id2    = $update['callback_query']['message']['message_id'] ?? null;
$callback_username2 = $update['callback_query']['from']['username'] ?? $username2; // Fallback to $username2 if not available
$callback_firstname2 = $update['callback_query']['from']['first_name'] ?? $firstname;
$userId2         = $update['callback_query']['from']['id'] ?? null;
$username3       = '@' . ($username2 ?? 'unknown_user'); // Safely concatenate '@' with fallback to 'unknown_user'

// $username3       = '@'.$username2;
 $info            = json_encode($update, JSON_PRETTY_PRINT); 
$emojid = '❌';
$emojil = '✅';
$owner = '<code>@shmoxd</code>';
$botu = "𝘽𝙊𝙏 𝙐𝙋𝘿𝘼𝙏𝙀𝙎 ↯ @shmoxd";
$bota = "<b>|×| 𝘿𝙀𝙑 ↯ @shmoxd</b>";$eror = "<b>Error ❌</b>";
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "↯ 𝘽𝙐𝙔 𝘼𝘾𝘾𝙀𝙎𝙎", 'url' => "https://t.me/Zerox_Owner"],
        ],
    ]
]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝙊𝙒𝙉𝙀𝙍", 'url' => "t.me/Zerox_Owner"], ['text' => "𝘾𝙃𝘼𝙉𝙉𝙀𝙇", 'url' => "https://t.me/Zeroxcreditshop"]],
        [['text' => "𝙂𝙊 𝘽𝘼𝘾𝙆 ", 'callback_data' => 'back2']]
    ]
]);
...
if ($cdata2 == "back2") {
    ...
    // Change this to your video url
    $backVideoUrl = "https://t.me/OWN_CHNL/10"; 
